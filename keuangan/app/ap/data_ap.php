        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <a href="../app/index_ap.php?page=input-data"><button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-lg">
                  Input Transaksi
                </button></a>
                <br></br>
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php
                    $no = 0;
                    $query = mysqli_query($koneksi, "SELECT * FROM tb_trans WHERE jenis = 'expense'");
                  ...
                  <tr>
                    ...
                    <td><a href="index_ap.php?page=edit-data&& id=<?php echo $money['id'];?>" class="btn btn-success">Edit</a>
